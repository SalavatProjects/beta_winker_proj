...
void _projectSerialize(
  ...
  writer.writeLongList(offsets[1], object.diaryIds);
...
Project _projectDeserialize(
  ...
  object.diaryIds = reader.readLongList(offsets[1]);
  object.id = id;
...
extension ProjectQueryFilter
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> diaryIdsIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'diaryIds',
      ));
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> diaryIdsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'diaryIds',
      ));
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> diaryIdsElementEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'diaryIds',
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> diaryIdsElementLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> diaryIdsElementBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> diaryIdsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> diaryIdsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'diaryIds',
        0,
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> diaryIdsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'diaryIds',
        0,
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> diaryIdsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> diaryIdsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ProjectQueryWhereDistinct
  ...
  QueryBuilder<Project, Project, QDistinct> distinctByDiaryIds() {
    return QueryBuilder.apply(this, (query) {
...
extension ProjectQueryProperty
  ...
  QueryBuilder<Project, List<int>?, QQueryOperations> diaryIdsProperty() {
    return QueryBuilder.apply(this, (query) {
