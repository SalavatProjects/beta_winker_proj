...
extension MarkQueryFilter on QueryBuilder<Mark, Mark, QFilterCondition> {
  ...
  QueryBuilder<Mark, Mark, QAfterFilterCondition> nameIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Mark, Mark, QAfterFilterCondition> nameIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Mark, Mark, QAfterFilterCondition> nameEqualTo(
    String? value, {
  ...
  QueryBuilder<Mark, Mark, QAfterFilterCondition> nameGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Mark, Mark, QAfterFilterCondition> nameLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Mark, Mark, QAfterFilterCondition> nameBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Mark, Mark, QAfterFilterCondition> nameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Mark, Mark, QAfterFilterCondition> nameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Mark, Mark, QAfterFilterCondition> nameContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Mark, Mark, QAfterFilterCondition> nameMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Mark, Mark, QAfterFilterCondition> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'name',
        value: '',
  ...
  QueryBuilder<Mark, Mark, QAfterFilterCondition> nameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'name',
        value: '',
...
extension MarkQuerySortBy on QueryBuilder<Mark, Mark, QSortBy> {
  QueryBuilder<Mark, Mark, QAfterSortBy> sortByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<Mark, Mark, QAfterSortBy> sortByNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MarkQuerySortThenBy on QueryBuilder<Mark, Mark, QSortThenBy> {
  ...
  QueryBuilder<Mark, Mark, QAfterSortBy> thenByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<Mark, Mark, QAfterSortBy> thenByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }
...
extension MarkQueryWhereDistinct on QueryBuilder<Mark, Mark, QDistinct> {
  QueryBuilder<Mark, Mark, QDistinct> distinctByName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension MarkQueryProperty on QueryBuilder<Mark, Mark, QQueryProperty> {
  ...
  QueryBuilder<Mark, String?, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
